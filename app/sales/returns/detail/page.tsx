...
export default function SalesReturnDetailPage() {
  ...
  const fetchReturn = async () => {
    try {
      ...
      setFormData({
        refund_method: data.data.refund_method || 'cash',
  ...
  if (!returnData) {
    return (
      <div className="p-6 text-center">
        ...
        <Link href="/sales/returns" className="text-blue-600 hover:text-blue-800 mt-4 inline-block">
          ← Back to Returns
        </Link>
      </div>
    );
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p className="font-medium text-blue-600">{returnData.customers.email || 'N/A'}</p>
              </div>
              <div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                ...
                <tbody>
                  {returnData.sales_return_items.map((item) => (
          ...
          <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-lg shadow p-6 border border-green-200">
            ...
            <div className="space-y-3 text-sm">
              <div className="flex justify-between">
                ...
                <span className="font-medium">{returnData.sales_return_items.length}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-600">Total Qty</span>
                <span className="font-medium">
                  {returnData.sales_return_items.reduce((sum, item) => sum + item.return_qty, 0)}
                </span>
              </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="space-y-3 text-sm">
              <div>
                ...
                <p className="font-mono font-semibold text-blue-600">{returnData.return_number}</p>
              </div>
              <div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="space-y-2">
              <button
                ...
                className="w-full border border-blue-600 text-blue-600 px-4 py-2 rounded hover:bg-blue-50 font-medium text-sm"
              >
                🖨 Print Return
              </button>
              {showDeleteConfirm ? (
