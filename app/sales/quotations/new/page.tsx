...
export default function NewQuotationPage() {
  ...
  const fetchData = async () => {
    setLoading(true);
    try {
      const [customersRes, storesRes, itemsRes] = await Promise.all([
  ...
  return (
    <div className="p-6">
      <h1 className="text-3xl font-bold mb-6">New Quotation</h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="bg-white rounded shadow p-6">
          ...
          {quotationItems.length === 0 && (
            <div className="text-center py-6 text-gray-500">No items added yet</div>
          )}
        </div>
