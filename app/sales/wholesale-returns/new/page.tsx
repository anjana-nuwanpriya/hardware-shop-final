...
export default function NewWholesaleReturnPage() {
  ...
  const handleSelectSale = (sale: Sale) => {
    ...
    setFormData({
      ...
      items: sale.sales_wholesale_items.map((item, idx) => ({
        id: String(idx),
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await fetch('/api/sales-wholesale-returns', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
          customer_id: formData.customer_id,
          store_id: formData.store_id,
          sales_wholesale_id: formData.sales_wholesale_id || null,
      ...
      router.push(`/sales/wholesale-returns?success=${result.data.return_number}`);
    } catch (err) {
  ...
  return (
    <div className="p-6 max-w-6xl mx-auto">
      ...
      <div className="mb-6">
        ...
        <h1 className="text-3xl font-bold mt-2">New Wholesale Return</h1>
        <p className="text-gray-600 text-sm mt-1">Process a wholesale customer return and generate refund</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow p-6 space-y-6">
        ...
        {formData.customer_id && formData.store_id && sales.length > 0 && (
          <div className="border-t pt-6 bg-purple-50 p-4 rounded-lg border border-purple-200">
              ...
              {sales.map((sale) => (
                ...
                >
                  ...
                  <div className="text-sm text-gray-600">
                    {sale.sales_wholesale_items.length} items | Total: Rs.{' '}
        ...
        {/* Total Section */}
        {total > 0 && (
          <div className="border-t pt-6 bg-gradient-to-r from-purple-50 to-purple-100 p-6 rounded-lg">
        ...
        <div className="flex gap-4 justify-end border-t pt-6">
          ...
          <button
            ...
            className="bg-purple-600 text-white px-8 py-2 rounded hover:bg-purple-700 disabled:opacity-50 disabled:cursor-not-allowed font-medium"
          >
